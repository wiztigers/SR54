...
Le nombre de succès obtenus en lançant les dés restants s'ajoute au nombre de succès automatiques.
...
La table ci-dessous donne des examples de signature correspondant à des objets courants.
