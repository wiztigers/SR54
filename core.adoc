...
groupes conservés tels quels: CRACKING, ELECTRONICS, TASKING, SORCERY, CONJURING, ENCHANTING

compétences hors de tout groupe:

* leadership, instruction -> *TODO* garder si ça sert réellement, sinon passer en compétences de connaissance
* gunnery, demolitions -> *TODO* voir comment ça marche, et prendre une décision


nouveau groupe: INFLUENCE
...
nouveau groupe: FIREARMS

* pistols
* rifles
* heavy weapons OR cyber-implanted ranged weapons

nouveau groupe: CLOSE COMBAT

* melee weapons
* unarmed combat
* esquive: parait bizarre ici car sert uniquement à distance, mais est utile dans ce groupe pour _atteindre_ le corps à corps


nouveau groupe: STEALTH

* sneaking: camouflage, discrétion, filature, palming
* perception
* lockpicking

nouveau groupe: OUTDOORS

* gymnastics (athlétisme)
* lancer + arc
* survival

nouveau group: ASTRAL CRAFT
* arcana: créer des trames de sort qui sont des entités astrales ... allez, ça va pas trop mal conceptuellement avec les deux autres
* assensing: trouver les indices dans la monde astral
* astral combat: taper les indices dans le monde astral

nouveau groupe: PILOT

* pilot aircraft + pilot aerospace
* pilot ground craft + pilot walkers
* pilot watercraft

nouvau groupe: ENGINEERING

* aeronautics + automotive + nautical mechanics = vehicle mechanic
* gun mechanic: build/repair every type of guns
* industrial mechanic: for all that is industrial but is neither a vehicle nor a gun
* artisan: for everything else, including paper/artistic forgery


nouveau groupe: BIOTECH

* medecine: first aid, physician, generalist job
* chirurgy: tout ce qu'on imagine se passer dans sur table d'op
* cybertechnology: tout ce qui est augmentation technologique


compétences de connaissance:

* etiquette (devient plusieurs compétences: etiquette:la rue, etiquette:corpos, etc)
* nautical mechanic: soit le perso n'a que ça comme mechanic et peu probable que ça serve, soit il a déjà payé pour d'autres mechanic donc on peut voir ça comme une "réduction". le cas où c'est trop rentable, à savoir le perso n'a que ça ET la campagne est marine tombe sous le coup de l'upgrade d'une compétence de connaissance en compétence active, donc on est bon.
* animal handling, escape artist, diving, free fall, performance, tracking


supprimées:

* groupe ACTING: tout est couvert par le groupe INFLUENCE
* exotic melee weapon, exotic ranged weapon, exotic vehicle
