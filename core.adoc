...
* 2 attributs spéciaux à choisir parmi 4 : Edge, Essence, Magie ou Résonance.
  Chacun est vraiment indépendant et peut progresser au delà de 6 (oui, même l'Essence).
...
* Un seule méthode au karma pour créer _et_ faire progresser un perso.
  Une méthode alternative de création _réellement_ rapide est proposée.
...
* Seulement _trois types d'actions matricielles_ : analyse, contrôle, combat.
...
* La _signature_ s'applique à tout : armes, implants, persos, véhicules, infos ...
