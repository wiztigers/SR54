...
.Types de blessure
[width=40%, cols="1,1,2" option="header"]
|===
|*Succès* |*Blessure* |*Cases cochées*
|1        |Légère     |1
|2        |Moyenne    |3
|3        |Grave      |6
|4        |Fatale     |10
...
Cette règle propose d'accélérer le jeu, aussi bien en rendant plus immédiate la gestion des blessures qu'en augmentant la lethalité des combats en utiliser un seul moniteur de condition au lieu de <<attribute_condition_monitor,deux>>.

Puisque ce moniteur trace à la fois les dommages physiques et étourdissants, son nombre de case est 8 + VOLONTÉ/2 + CONSTITUTION.
...
Quand le moniteur de condition d'un personnage est rempli d'un mix de "coches" et de "croix", et qu'il subit des dommages (que ceux-ci soient physiques ou étourdissants) les coches deviennent des croix. Quand il n'y a plus de croix, la mort est proche.
