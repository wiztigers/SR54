...
Évidemment, les modificateurs apportés par les outils d'un personnage ne remplacent pas tout modificateur positif ou négatif dus aux circonstances dans lesquelles un personnage utilise sa compétence.
