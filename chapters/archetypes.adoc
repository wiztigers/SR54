...
9500¥
2+>.^h|Traits [.formula]#(0)# 8+<|
<<quality_exceptional_attribute,Charisme exceptionnel>> ^R^, <<quality_vision_low-light,Vision nocturne>> ^R^
|===
...
<<quality_exceptional_attribute,Attribut spécial>> (<<attribute_magic,Magie>>), <<quality_conjurer,Invocateur>>, <<quality_sorcerer,Sorcier>>, <<quality_astral_projection,Projection astrale>>, <<quality_vision_astral,Vision Astrale>>
|===
...
3500¥
2+>.^h|Traits [.formula]#(0)# 8+<|
<<quality_exceptional_attribute,Edge exceptionnel>> ^R^
|===
