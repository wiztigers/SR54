...
Construire, entretenir ou réparer tout ce qui n'est pas couvert par les compétences <<skill_armorer,Armurerie>> ou <<skill_mechanic,Mécanique>>.
...
Distinguer si une tâche est couverte par la compétence <<skill_artisan,Artisanat>> ou <<skill_mechanic,Mécanique>> peut être difficile.
