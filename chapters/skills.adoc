...
[NOTE.example,caption="Exemple"]
====
Fyif a toujours apprécié le fait de chevaucher les cheveux au vent pour oublier ses soucis.
Son souci du jour est une bande d'elfes habillés en pingouins, enervés parce que quelqu'un a mis le feu une aile de leur country club.
Même si ils n'avaient qu'à y accepter les jeunes orkes assoiffées, Fyif préfére prendre la fuite plutôt que de continuer à en débattre avec eux.
...
Un succès à un jet d'[.formula]#<<attribute_intelligence,Intelligence>> ×2# lui permet de trouver un cheval en forme, en bon état, mais assez affolé.
...
Et c'est parti !
Fyif s'élance au vent sous le regard médusé des elfes, et l'effet apaisant de la cavalcade et du vent sur son visage lui fait déjà oublier ses soucis.
