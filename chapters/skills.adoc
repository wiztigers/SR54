...
* Ça accélère la création de perso : jette quelques centres d'intérêt de ton perso sur ta feuilles, compte 5 points de karma pour chaque, fini !
...
Un succès à un jet d'[.formula]#<<attribute_intelligence,Intelligence>> ×2# lui rappelle qu'une manière particulière de cuisiner les œufs pochés issue du terroir anglais ferait honneur aux origines du lord.
...
Le MJ requiert un test d'[.formula]#<<attribute_intelligence,Intelligence>> + <<attribute_agility,Agilité>># avec un seuil de 3 pour réaliser correctement la recette.
