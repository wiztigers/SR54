...
** Pour 10 points, le seuil pour les détecter augmente de 2.
** Pour 15 points, détecter ses augmentations nécessite un examen médical approfondi.
   ...
   le seuil pour détecter ses augmentations augmente de 1.
** Pour 20 points, seule la magie permet de les détecter.
   Même alors, le seuil de <<skill_assensing,lecture d'aura>> augmente de 2.
...
** Pour 15 points, ses implants illégaux sont détectés automatiquement lors d'un contrôle.
